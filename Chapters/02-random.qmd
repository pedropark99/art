...
You just add two new columns in this `data.frame` to store the x and y coordinates
...
of this characteristic, is that you get a very smooth transition between each random value in the
