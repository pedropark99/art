...
these formulas above and you will be happy. Lets take a triangle
with coordinates $(0,0), (1,0), (0,2)$ as an example.
Lets consider we wanted to perform two different rotations.
The first, we rotate the triangle 30 degrees clockwise, the second, 90 degrees clockwise.
