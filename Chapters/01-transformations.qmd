...
omitted for brevity reasons). To help you visualize, I also draw the
circle that is centered at the origin point. You can see that the
rotated triangles follows the circumference.
